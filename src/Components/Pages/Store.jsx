...
function Store() {
  ...
  <h3>QR Code Generator</h3>
        ...
        <button className="choose-plan-btn gradient-btn" style={{ marginTop: '32px' }}>Free Tool with Zencia</button>
      </div>
        <div className="pricing-card popular">
      <div className="tool-card-icon" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
  ...
  <div className="tools-section">
    ...
    <div className="tools-grid">
        ...
        <button className="choose-plan-btn gradient-btn" style={{ marginTop: '32px' }}>Coming Soon</button>
      </div>
        <div className="pricing-card popular">
        <div className="tool-card-icon">
          <img src="data:image/svg+xml;base64," alt="Merge PDF" />
        ...
        <p>These minutes summarize key points, decisions, and action items discussed during the meeting, presenting them in a single, well-organized document. With the ability to customize the order of content.</p>
        <button className="choose-plan-btn gradient-btn" style={{ marginTop: '32px' }}>Coming Soon</button>
      </div>
        <div className="pricing-card popular">
        <div className="tool-card-icon">
