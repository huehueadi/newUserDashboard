...
<div className="container">
  ...
  <h2 className="section-title">Zencia App Store</h2>
  ...
  <h3>QR Code Generator</h3>
        ...
        <button className="tool-card-btn">Free Tool with Zencia</button>
      </div>
      <div className="tool-card">
      <div className="tool-card-icon" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
  ...
  <div className="tools-section">
    ...
    <div className="tools-grid">
      <div className="tool-card">
        ...
        <button className="tool-card-btn">Coming Soon</button>
      </div>
      <div className="tool-card">
        <div className="tool-card-icon">
          <img src="data:image/svg+xml;base64," alt="Merge PDF" />
      ...
      <div className="tool-card">
        ...
        <p>Tender.AI simplifies the tender filing process with powerful AI-driven tools. Users can effortlessly upload tender-related documents in formats like PDFs, images, or text, and the system organizes them for easy submission. Its intuitive AI assists in drafting precise responses, ensuring compliance, and streamlining the entire bidding process with speed and accuracy.</p>
        <button className="tool-card-btn">Coming Soon</button>
      </div>
    </div>
  </div>
